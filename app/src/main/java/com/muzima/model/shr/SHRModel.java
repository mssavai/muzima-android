...
public class SHRModel {
     ...
     * @param cardDetails
     */
    public SHRModel(PatientIdentification patientIdentification, List<NextOfKin> nextOfKins, List<HIVTest> hivTests, List<Immunization> immunizations, CardDetails cardDetails) {
        super();
    ...
    public static SHRModel createSHRModelFromJsonString(String jsonSHRModel) throws IOException{
        ObjectMapper objectMapper = new ObjectMapper();
        SHRModel shrModel = objectMapper.readValue(jsonSHRModel,SHRModel.class);
        return shrModel;
    }

    public static String createJsonSHRModel(SHRModel shrModel) throws IOException{
        ObjectMapper objectMapper = new ObjectMapper();
        return objectMapper.writeValueAsString(shrModel);
    }

    public static SHRModel createBlankSHRModel(){
        try {
