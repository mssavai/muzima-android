...
import com.muzima.utils.javascriptinterface.PerformanceLoggingJavascriptInterface2;
...
public class ProviderPerformanceReportViewActivity2 extends ProviderReportViewActivity {
    ...
    private void setupWebView() {
        ...
        webView.addJavascriptInterface(new FormDataJavascriptInterface((MuzimaApplication) getApplicationContext()),
                "formDataInterface");
        webView.addJavascriptInterface(new PerformanceLoggingJavascriptInterface2(ProviderPerformanceReportViewActivity2.this),
                "loggingInterface");
        ...
        webView.loadUrl("file:///android_asset/www/reports/pls2/index.html");
    }
    ...
    public void loadMapsPage(){
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                webView.loadUrl("file:///android_asset/www/reports/pls2/map.html");
            }
        });
    }
    ...
    private WebChromeClient createWebChromeClient() {
        return new WebChromeClient() {
            ...
            public void onProgressChanged(WebView view, int progress) {
                ProviderPerformanceReportViewActivity2.this.setProgress(progress * 1000);
                if (progress == 100) {
